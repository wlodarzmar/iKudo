...
namespace iKudo.Domain.Migrations
{
    ...
    [Migration("20181102185429_Users_FirstName_Nullable_Email_Or_FirstName_Required")]
    partial class Users_FirstName_Nullable_Email_Or_FirstName_Required
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iKudo.Domain.Model.BoardInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("iKudo.Domain.Model.BoardInvitation", b =>
                {
                    ...
                    b.HasOne("iKudo.Domain.Model.User", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("iKudo.Domain.Model.Notification", b =>
                {
                    ...
                    b.HasOne("iKudo.Domain.Model.Kudo", "Kudo")
                        .WithMany()
                        .HasForeignKey("KudoId")
                        .OnDelete(DeleteBehavior.Restrict);
